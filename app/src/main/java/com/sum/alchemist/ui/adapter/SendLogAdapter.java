...
public class SendLogAdapter extends BaseRecyclerAdapter<Object> {
    @Override
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SimpleViewHolder(View.inflate(parent.getContext(), R.layout.item_send, null));
    }
    ...
    public void onBindViewHolder(final SimpleViewHolder holder, int position) {
        ...
        try {
            ...
            holder.getView(R.id.menu_delete).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(hasItemListener()){
                        adapterItemListener.onItemClickListener(object, holder.getAdapterPosition(), R.id.menu_delete);
                    }
                }
            });
