...
import com.sum.alchemist.ui.adapter.LikeAdapter;
...
public class LikeListActivity extends BaseActivity {
    ...
    AdapterItemListener<Object> adapterItemListener = new AdapterItemListener<Object>() {
        ...
        public void onItemClickListener(Object data, int position, int id) {
            if(data instanceof Provision && id == 0){
                ...
                startActivity(new Intent(LikeListActivity.this, MissionDetailActivity.class)
    ...
    public void onRefreshData() {
        addSubscrebe(UserImpl.getInstance().getUserLike(0, 10)
    ...
    public void loadMoreDate() {
        ...
        isLoad = true;
        addSubscrebe(UserImpl.getInstance().getUserLike((pageIndex+1) * 10, 10)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<List<Object>>() {
                    @Override
